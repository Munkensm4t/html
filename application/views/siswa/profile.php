...
<div id="content" class="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="widget-heading text-center">
                                ...
                                <p style="margin-top: -10px;">SISWA LMSJP</p>
    ...
    <div class="footer-wrapper">
        <div class="footer-section f-section-1">
            <p class="">Copyright © 2021 <a target="_blank" href="http://bit.ly/demo-abdul" class="text-primary">Alif D.</a></p>
        </div>
        <div class="footer-section f-section-2">
            <p class="">LMSJPs v 1.1</p>
        </div>
    </div>
</div>
<!--  END CONTENT AREA  -->
