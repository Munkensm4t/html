...
class Download extends CI_Controller
{
    ...
    public function nilai_pg($data_kode_ujian, $data_id_siswa)
    {
        ...
        <img src="'. base_url('assets/app-assets/img/gb2LMSJP.png') .'" width="120px" style="margin-top: 20px;" alt="logo-aplikasi">
        </div>', 'O');
        $mpdf->SetHTMLHeader('<div style="text-align: left; margin-left: 20px; font-weight: bold;">
        <img src="'. base_url('assets/app-assets/img/gb2LMSJP.png') .'" width="120px" style="margin-top: 20px;" alt="logo-aplikasi">
        </div>', 'E');
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                ...
                <td width="33%" style="text-align: right; border: none;">LMSJP V2 by Alif D.</td>
            </tr>
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                <td width="33%"><span style="font-weight: bold; font-style: italic;">LMSJP V2 By Alif D./span></td>
        ...
        $html = '
            ...
            <body>
            <h2 style="text-align: center;">LMSJP V2 BY Alif D.<br><small>Built With Codeignite 3 & PHP 7</small></h2>
