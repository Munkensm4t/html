    ...
    public function register()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->input->post('saya_siswa')) {
                ...
                $this->email->from("$email_app->email", 'LMSJP');
                $this->email->to($email);
                ...
                $this->email->message('
                    <div style="color: #000; padding: 10px;">
                        ...
                        <small style="color: #000;">V 1.0 by Alif D.</small>
                        <br>
                        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">Hallo ' . $this->input->post('nama') . ' <br>
                            <span style="color: #000;">Anda telah Melakukan Pendaftaran ke LMSJP sebagai SISWA. Silahkan lakukan aktivasi dengan cara mengklik tombol aktivasi</span><br>
                            </p>
                ...
                $this->email->message('
                    <div style="color: #000; padding: 10px;">
                        ...
                        <br>
                        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">Hallo ' . $this->input->post('nama') . ' <br>
                            <span style="color: #000;">Anda telah Melakukan Pendaftaran ke LMSJP sebagai GURU. Silahkan lakukan aktivasi dengan cara mengklik tombol aktivasi</span><br>
                        </p>
                        <a href="' . base_url() . 'auth/verify?email=' . $email . '&token=' . $token .  '" style="display: inline-block; width: 100px; height: 30px; background: #1C3FAA; color: #fff; text-decoration: none; border-radius: 5px; text-align: center; line-height: 30px; font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif;">
                            aktivasi        
                        </a>
